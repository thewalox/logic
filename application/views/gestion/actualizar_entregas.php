			...
			<section class="posts col-md-12">
				<div class="miga-de-pan">
					<ol class="breadcrumb">
						...
						<li class="active">Actualizar Entregas</li>
					</ol>
				</div>
				<?php
					$atributos = array('id' => 'form-upload');
					echo form_open_multipart(base_url()."gestion/actualizar_entregas", $atributos);
				?>
							...
							//for(datos in json){
								...
								if (json.tipo == 0) {
									...
									html = "<div class='alert alert-success alert-dismissible text-center' role='alert'>";
		  							...
		  							html += "<div>Registros No Actualizados: " + json.no + "</div>";
		  							html += "<div>Registros Actualizados: " + json.edit + "</div>";
									html += "</div>";

									for (res in json.resultado) {
										html += "<div class='alert alert-danger alert-dismissible text-center' role='alert'>";
										html += "Este documento no pudo ser actualizado: " + json.resultado[res].documento;
										html += "</div>";
									}
